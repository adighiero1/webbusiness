                ...
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                    ...
                    <div className="flex flex-row items-center justify-around text-center">
                        ...
                        <div className="col-span-6 md:col-span-6 lg:col-span-4">
                            <h6 className="text-black text-xl font-bold mb-4">NUESTROS SERVICIOS</h6>
                            <ul className="text-md">
                                <li className="mb-2">
                                    <Link to="#" className="text-black hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Desarrollo Web</Link>
                                </li>
                                <li className="mb-2">
                                    <Link to="#" className="text-black hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Servicios de Dominio y Alojamiento</Link>
                                </li>
                                <li className="mb-2">
                                    <Link to="#" className="text-black hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Consultoría General</Link>
                                </li>
                            </ul>
                        </div>

                        {/* 4th block */}
                        <div className="col-span-12 text-center lg:col-span-3 font-bold uppercase text-black">
