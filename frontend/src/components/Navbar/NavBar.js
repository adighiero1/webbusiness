...
import logo from '../../images/widulognav.png';
...
const NavBar = () => {
    ...
    return (
        <nav className={`bg-black opacity-80 fixed top-0 w-full z-30 transition duration-300 ease-in-out mb-16 text-white ${!top && 'bg-black shadow-lg'}`}>
            <div className="flex flex-row justify-between items-center py-2">
                <div className="flex flex-row justify-center md:px-12 md:mx-12 items-center text-center font-semibold">
                    <HashLink smooth to="/#hero">
                        <img src={logo} className='custom-logo-nav h-16 w-52' alt='widu logo' />
                    </HashLink>
                </div>
